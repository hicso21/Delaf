...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/calendar` | `/chat` | `/chat/global` | `/chat/juan` | `/config` | `/frecuency` | `/home` | `/login` | `/marchView` | `/multimedia` | `/multimedia/audio` | `/multimedia/text` | `/multimedia/tip` | `/multimedia/video` | `/nutrition` | `/payment` | `/prices` | `/profile` | `/races` | `/recovery` | `/redirect` | `/register` | `/routines` | `/stats` | `/status` | `/sync` | `/user` | `/vo2`;
  type DynamicRoutes<T extends string> = `/nutrition/${SingleRoutePart<T>}` | `/prices/${SingleRoutePart<T>}` | `/routines/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/nutrition/[id]` | `/prices/[price_id]` | `/routines/[_id]`;
