		...
		return item?.repeat > 1 ? (
			...
			>
				...
				>
					...
					>
						<Text adjustsFontSizeToFit={true} style={{ fontSize: 18, textAlign: 'center' }}>
							{item?.name == 'race'
						...
						>
							<Text adjustsFontSizeToFit={true}>{toSeeMeasure(item)}</Text>
							<Text adjustsFontSizeToFit={true} style={{ fontSize: 18 }}>
								{item?.category &&
		...
		<>
			...
			>
				...
				>
					...
					>
						...
						<Text adjustsFontSizeToFit={true} style={{ fontSize: 24 }}>
			...
			<Portal>
				...
				>
					...
					>
						<Text adjustsFontSizeToFit={true} style={{ fontSize: 22 }}>
						...
						<View style={{ flexDirection: 'row', gap: 25 }}>
							...
							>
								<Text adjustsFontSizeToFit={true} style={{ color: '#000' }}>Cancelar</Text>
							</TouchableOpacity>
							<TouchableOpacity
							...
							>
								<Text adjustsFontSizeToFit={true} style={{ color: '#f6f6f6' }}>
									Confirmar
								</Text>
							</TouchableOpacity>
						</View>
			...
			>
				{isLoading ? (
					...
					<>
						...
						>
							<Text adjustsFontSizeToFit={true} style={{ fontSize: 28 }}>
								{routine?.title}
							</Text>
						</View>
						<View
						...
						<View>
							<TouchableOpacity onPress={onConfirmationModalOpen}>
								<Text adjustsFontSizeToFit={true}>Ya completaste tu rutina?</Text>
							</TouchableOpacity>
						</View>
					</>
				)}
